describe('linkedList', function () {
	...
	it('should have methods named "addToTail", "removeHead", and "contains"', function () {
		...
		expect(linkedList.addAnywhere).to.be.a("function");
	...
	it('should add nodes to the begining of the list', function() {
	...
	it('should add node to any point in the list', function() {
		linkedList.addToTail(3);
		linkedList.addToTail(4);
		linkedList.addToTail(5);
		linkedList.addToHead(6);
		linkedList.addAnywhere(7, 1);
	...
	it('should remove from the tail of the list when removeTail is called', function() {
